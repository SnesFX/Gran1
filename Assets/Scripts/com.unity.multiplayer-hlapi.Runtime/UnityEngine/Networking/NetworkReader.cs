...
namespace UnityEngine.Networking
{
	...
	public class NetworkReader
	{
		...
		{
			return (short)(ushort)((ushort)(0 | m_buf.ReadByte()) | (ushort)(m_buf.ReadByte() << 8));
		}

		public ushort ReadUInt16()
		{
			return (ushort)((ushort)(0u | m_buf.ReadByte()) | (ushort)(m_buf.ReadByte() << 8));
		}

		public int ReadInt32()
		{
			return 0 | m_buf.ReadByte() | (m_buf.ReadByte() << 8) | (m_buf.ReadByte() << 16) | (m_buf.ReadByte() << 24);
		}

		public uint ReadUInt32()
		{
			return 0u | m_buf.ReadByte() | (uint)(m_buf.ReadByte() << 8) | (uint)(m_buf.ReadByte() << 16) | (uint)(m_buf.ReadByte() << 24);
		}
