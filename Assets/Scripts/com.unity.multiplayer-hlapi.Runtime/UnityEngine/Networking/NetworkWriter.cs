...
namespace UnityEngine.Networking
{
	...
	public class NetworkWriter
	{
		...
		public void WritePackedUInt32(uint value)
		{
			...
			{
				Write((byte)250);
				Write((byte)(value & 0xFFu));
				Write((byte)((value >> 8) & 0xFFu));
				Write((byte)((value >> 16) & 0xFFu));
			}
			else
			{
				Write((byte)251);
		...
		{
			m_Buffer.WriteByte2((byte)((uint)value & 0xFFu), (byte)((uint)(value >> 8) & 0xFFu));
		}

		public void Write(ushort value)
		{
			m_Buffer.WriteByte2((byte)(value & 0xFFu), (byte)((uint)(value >> 8) & 0xFFu));
		}

		public void Write(int value)
		{
			m_Buffer.WriteByte4((byte)((uint)value & 0xFFu), (byte)((uint)(value >> 8) & 0xFFu), (byte)((uint)(value >> 16) & 0xFFu), (byte)((uint)(value >> 24) & 0xFFu));
		}

		public void Write(uint value)
		{
			m_Buffer.WriteByte4((byte)(value & 0xFFu), (byte)((value >> 8) & 0xFFu), (byte)((value >> 16) & 0xFFu), (byte)((value >> 24) & 0xFFu));
		}
